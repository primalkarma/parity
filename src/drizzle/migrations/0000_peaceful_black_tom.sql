...
--> statement-breakpoint
ALTER TABLE "country_group_discounts" ADD CONSTRAINT "country_group_discounts_id_country_groups_id_fk" FOREIGN KEY ("id") REFERENCES "public"."country_groups"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
